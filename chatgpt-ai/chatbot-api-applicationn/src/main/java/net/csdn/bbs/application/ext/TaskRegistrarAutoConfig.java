package net.csdn.bbs.application.ext;


import net.csdn.bbs.application.job.ChatbotTask;
import net.csdn.bbs.common.PropertyUtil;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void setEnvironment(Environment environment) {
        ...
        for (String groupKey : launchListStr.split(",")) {
            Map<String, Object> taskGroupProps = PropertyUtil.handle((org.omg.CORBA.Environment) environment, prefix + groupKey, Map.class);
